      ...
      <section className="bg-blue-900 text-white py-16">
        <div className="container mx-auto px-4 flex flex-col sm:flex-row items-center justify-between">
          <div className="flex-1">
            <img src="src/assets/images/mobile.png" alt="Mobile" className="w-full max-w-xs" />
          </div>
            ...
            <div className="space-y-4 sm:space-y-0 sm:space-x-4 flex flex-col sm:flex-row justify-center sm:justify-start">
              <a href="#" className="inline-block">
                <div className="bg-white text-black border border-gray-300 rounded-lg p-2 flex items-center gap-2 w-40">
                  <img src="src/assets/images/apple.png" alt="Apple Icon" className="w-6 h-6" />
              ...
              <a href="#" className="inline-block">
                <div className="bg-white text-black border border-gray-300 rounded-lg p-2 flex items-center gap-2 w-40">
                  <img src="src/assets/images/android.png" alt="Play Store Icon" className="w-6 h-6" />
                  <div className="text-left">
                    <div className="text-sm">Get it on</div>
